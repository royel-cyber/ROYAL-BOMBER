# Decompile by Mardis (Tools By GR ALEX )
...
\033[1;32m[-] AUTHOR    :\033[1;32m GR ALEX
...
rp= 'ALEX'
x = 'ALEX'
if 'ALEX'==user and 'ALEX'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY FACEBOOK GROUP ")
	os.system('xdg-open https://facebook.com/groups/1426704671516149/')
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	os.system("xdg-open https://wa.me/+8801300100454")
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH ROYEL-CYBER™ ;) {w}<{r}/{w}>\n\n")
...
os.system("xdg-open https://www.facebook.com/rg.zihat")
print (logo)
print(f"""\n{ran}\033[1;31m                                                               
\t\033[1;32m                 
\t\033[1;32m                
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥ROYEL-CYBER™🔥 "+w+tim)
